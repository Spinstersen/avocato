# 05 — Fiscalité MRE : Résident 183j vs Non-Résident (CGI art.23)

> Renvoi `08_Fiscalite_Internationale_Rapatriement/01_Residence_Fiscale_183j_Foyer.md` + `05_Conventions_Fiscales_Bilaterales.md`.
...
## MRE 210j (retour été + télétravail) = résident

*   >183j Casa → résident → IS mondial Maroc (SARL Casa + revenus France) → convention art.27 crédit.

## Tableau

| Jours | Foyer | Résident | IS | Besoin |
|---|---|---|---|---|
| 40j | Paris | Non-résident | 15% source | Dividende 10% France |
| 210j | Casa | Résident | Mondial 15% | Attestation DGI + crédit France |

## Mission co-traitance

*   Diagnostic résidence 1,200 HT (comptable chiffre IS, avocat foyer).

## Checklist

*   [ ] 183j compté
*   [ ] Foyer Paris/Casa
*   [ ] Attestation si résident
*   [ ] Convention art.4/27
