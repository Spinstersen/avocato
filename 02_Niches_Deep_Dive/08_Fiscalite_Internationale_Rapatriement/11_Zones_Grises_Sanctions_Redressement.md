# 11 — Zones Grises, Sanctions & Redressement (30% + 15% + Office)

## Zones grises fréquentes

| Situation | Vert (OK) | Orange (risque) | Rouge (interdit) |
|---|---|---|---|
| Nomad 210j sans carte séjour | — | Touriste 90j renouvelé 2× (180) gris | 210j sans carte → séjour irrégulier |
...
*   J+1 contrôle → saisir comptable agréé <48h → déclaration rectificative + provision 30% → demande Office atténuation si bonne foi IGOC.
