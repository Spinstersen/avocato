...
| # | Fichier | Quand |
|---|---------|-------|
| 00 | `00_INDEX.md` | Vous y êtes — arbre choix |
| 01 | `01_Residence_Fiscale_183j_Foyer.md` | Déterminer résidence |
| 02 | `02_Salarie_Hors_Maroc_Detachement_Portage.md` | Cas salarié remote hors Maroc |
| 03 | `03_Freelance_Ecom_Rapatrier_AE_SARL_Succursale.md` | Quel statut pour rapatrier |
| 04 | `04_Statut_Juridique_Nomad_Carte_Sejour.md` | Nomad légal |
| 05 | `05_Conventions_Fiscales_Bilaterales.md` | 4 conventions détaillées |
| 06 | `06_Rapatriement_Dividendes_Salaires_Change.md` | IGOC ↔ Office des changes |
| 07 | `07_Etablissement_Stable_Prix_Transfert.md` | Risque PE 6 mois |
| 08 | `08_Missions_Pack_International_Fiscal.md` | 5 missions 1,200-7,500 HT |
| 09 | `09_Cas_Pratiques_3_Internationaux.md` | Yassine/Salma/Karim chiffrés |
| 10 | `10_Arbre_Decision_Statut_International.md` | Quel statut en 2 min |
| 11 | `11_Zones_Grises_Sanctions_Redressement.md` | Risques 30% majoration |
| 12 | `12_Fiches_Checklist_CoTraitance_Comptable.md` | Checklist tripartite |

## Arbre décision ultra-rapide

```
Es-tu résident 183j Maroc ?
├─ OUI (MRE rentré / nomad >183j) → IS mondial Maroc, convention art.4 foyer, rapatriement dividendes 15% → Pack 7,500
└─ NON (non-résident, freelance US paie Maroc) → IS source Maroc seulement, TVA art.92 exon, compte convertible → Pack 5,900
   └─ Salarié hors Maroc ?
       ├─ OUI → Détachement 12m vs Portage (voir 02)
       └─ NON → Freelance/ecom → AE/SARL/Succursale (voir 03)
```
...
## Réseau comptable sans friction

*   Toi = statut/convention/contrats/IGOC/devoir conseil.
*   Comptable agréé = CGI chiffrage exact, liasse, télé-déclaration IS/IR.
*   Convention tripartite: honoraires avocat HT + débours comptable en sus, pas de commission `01_Strategy/01_Rules/06_Apporteur_Affaires_Partenariats.md`.
