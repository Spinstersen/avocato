# 09 — Office des Changes & Dotations (IGOC 2024) : Dossier Maître Encyclopédique
...
*   **6 Dotations libéralisées:** Voyage 100k DH/an, E-commerce 15k DH/an (douleur #1 freelance), Investissement étranger 100M DH, Export/Import, Etudes 50k.
*   **Règle 30j:** Toute entrée devise >1,000 DH = justifier 30j (contrat+facture+avis) `01_Freelancers.../02_Douleurs_Juridiques.md:40` + `08_Fiscalite.../06_Rapatriement...`.
*   **Comptes:** Convertible, Devise MRE, Devise résident `05_MRE.../02_Douleurs_Juridiques.md:40`.
*   **Sanction:** Loi 19-06: amende 3k-30k DH + blocage + interdiction chèque si défaut 30j.
...
| 01 | `01_Cadre_IGOC2024_Loi1906.md` | Cadre général |
| 02 | `02_Dotation_Voyage_100k.md` | Voyage perso |
| 03 | `03_Dotation_Ecommerce_15k.md` | SaaS/ads freelancer |
| 04 | `04_Dotation_Investissement_100M.md` | Investir à l'étranger |
| 05 | `05_Import_Export_Rapatriement_30j.md` | Rapatrier 30j |
| 06 | `06_Compte_Devise_Convertible_MRE.md` | Ouvrir compte |
| 07 | `07_Obligations_Rapatriement_Justificatifs.md` | Justif banque |
| 08 | `08_Infractions_Sanctions_Loi1906.md` | Sanctions |
| 09 | `09_Missions_Pack_Change.md` | 1,500-3,500 HT |
| 10 | `10_Cas_Nomad_US_LLC_Rapatriement.md` | 3 cas chiffrés |
| 11 | `11_Arbre_Dotation_Quelle_Dotation.md` | Arbre 2 min |
| 12 | `12_Fiches_Formulaires_Office.md` | Formulaires RC1/RC2 + checklist |
...
| Import | Valeur facture | Importateur | Domiciliation | Banque |
| Export rapatriement | 100% 30j | Exportateur | Contrat+facture | Banque |

## Liens

*   Préalable: `08_Fiscalite_Internationale_Rapatriement/`
*   MRE: `10_MRE_Entrepreneurs/` + `11_Nomads_Digital/`
*   Change: `08_Fiscalite.../06_Rapatriement...`
