...
```
CA >200k (service) ou >500k (commerce) 02_Ecommerce_Dropshipping_YouCan ?
...
**Pour E-commerce YouCan** : L'arbre évite l'erreur de choisir le statut avant la résidence — choisir SARL avant de savoir si l'on est résident 210j (IS mondial) ou non-résident 40j (IS source) inverse le conseil.
