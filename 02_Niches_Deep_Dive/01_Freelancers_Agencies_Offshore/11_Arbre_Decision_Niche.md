...
L'arbre n'est pas un automate qui décide à la place du client. Il hiérarchise les questions préalables : 1) Suis-je au-dessus du seuil légal ? (AE 200k/500k — CGI art. 42 s.), 2) Suis-je résident 183j ou foyer au Maroc ? (CGI art. 23), 3) Ai-je un établissement stable ? (définition et seuil selon la convention applicable — n° d'article à vérifier, pas de « art. 7 » générique). Chaque branche renvoie à une mission avec convention, pas à un produit panier.

**Pour Freelance offshore** : L'arbre évite l'erreur de choisir le statut avant la résidence — choisir SARL avant de savoir si l'on est résident 210j (IS mondial) ou non-résident 40j (IS source) inverse le conseil.
