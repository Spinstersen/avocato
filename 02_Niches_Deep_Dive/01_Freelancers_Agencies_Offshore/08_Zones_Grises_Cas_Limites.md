...
## 5 Zones grises 01_Freelancers_Agencies_Offshore
...
*   **Faits:** 01_Freelancers_Agencies_Offshore client 250k CA, 210j Maroc, 1 salarié Paris remote 7 mois.
*   **Analyse:** 210j → résident `08_Fiscalite.../01_Residence...` → IS mondial 20% (taux 2026) ; salarié 7m → PE France 25% ; rapatriement IGOC à justifier.
*   **Solution:** SARL + portage + justificatifs change → pack complet chiffré au diagnostic.
...
**Freelance offshore** illustre la tension entre texte et pratique. La loi fixe un principe (ex: preuve écrite >10 000 DH DOC art. 443), la pratique tolère un oral en dessous, la banque exige un écrit au-delà de 30j IGOC. La zone grise naît de l'écart entre tolérance commerciale et exigence probatoire.

**Raisonnement en 3 temps** :
1.  **Qualification** : le fait entre-t-il dans le champ du texte ? (ex: CA 210k >200k → AE services dépassé, CGI art. 42 s.).
2.  **Risque** : quel est le coût du dépassement ? (radiation RNAE + bascule de régime + régularisation vs tolérance d'une première année).
3.  **Parade** : quelle formalité purge le risque ? (diagnostic 900 HT → SARL 7-14j).

**Exemple Freelance offshore** : Un e-commerçant YouCan 600k commerce sans registre CNDP pense être couvert par ses CGV. La zone grise est le registre 09-08 : la loi est claire (registre + formalités préalables ; défaut de formalités = amende 10 000-100 000 DH, art. 64) mais le contrôle, lui, est déclenché par plainte — le « pas encore contrôlé » n'est pas « conforme ». L'avocat ne tranche pas à la place du client : il expose la zone, chiffre les deux branches, et propose la convention qui couvre la branche prudente.

> Références : Contrat prestation FR/EN, TVA art. 92, statut AE 200k/500k (CGI art. 42 s.), IGOC édition courante (2026, oc.gov.ma), PI loi 17-97 (marques) et loi 2-00 (auteurs), DOC, CGI, sgg.gov.ma — vérifications 28/08/2026.
