...
## Mission 1 — Diagnostic d'Encadrement Contractuel et Statutaire (Honoraires indicatifs : 900 DH HT)
...
*   Diagnostic facturé 900 DH HT, **déductible** de la mission suivante si engagement sous 30j. Convention ponctuelle art. 30, provision 100% (mission courte).

### Hors périmètre

*   Rédaction du contrat définitif (Mission 2), création SARL (Mission 3), structuration offshore (Mission 4). Comptable agréé associé pour chiffrage IS/IR.

---

## Mission 2 — Rédaction du Contrat de Prestation International FR/EN (Honoraires indicatifs : 3 500 DH HT)

### Pourquoi

Art. 443 DOC : preuve écrite exigée au-delà de 10 000 DH. Sans clause de cession PI (Loi 2-00 art. 9-12), le code reste au prestataire mais le client revendique l'usage. Sans clause TVA art. 92 CGI, le freelance facture 20% en trop à un client US exonéré.
...
*   Entretien 30 min + draft J3 + relecture client + version finale J7. Validation par l'avocat, pas par IA générative (voir `04_Skills_To_Learn/02_AI_For_Lawyers_Prompts/04_Deontologie_Validation.md`).

### Honoraires indicatifs

*   3 500 DH HT — provision 50% (1 750 HT). Délai 7 jours ouvrés après provision et pièces complètes.

---

## Mission 3 — Création de SARL-AU Dédiée à l'Activité Offshore (Honoraires indicatifs : 5 500 DH HT + débours OMPIC/CRI)
...
*   Frais OMPIC/CRI env. 1 500-2 500 DH (selon capital et frais JAL/BO).

### Co-traitance

*   Comptable agréé joint pour immatriculation fiscale et choix IS/IR.

---

## Mission 4 — Structuration des Flux Transfrontières et Paiements (Honoraires sur devis, indicatif 7 500-12 000 DH HT)
...
1.  Audit statut/flux/paiements (45 min).
2.  Note de choix 3 options (SARL Maroc seule, SARL + EURL étrangère via confrère, portage) avec avantages/inconvénients fiscaux et sociaux (avec comptable).
3.  Convention sur devis (art. 30).

---

## Mission 5 — Suivi et Secrétariat Juridique (Honoraires indicatifs : 2 500 DH HT/mois Starter, 4 500 HT/mois Business)

### Objet

Revue de contrats (5 ou 10/mois selon formule), réponse sous 48h, veille 09-08, atelier trimestriel. Résiliable 30j. Facturation mensuelle.

---

## Règles communes à toutes les missions

*   **Convention préalable** `05_Document_Bank/templates/01_Convention_Honoraires_Modele.md` — détaille objet, honoraires HT, TVA 20% ou exonération art. 91, provision, solde, délais, résiliation.
...
**Q : Pack sur mesure ?** R : Mission sur devis, honoraires indicatifs majorés 30-50% selon volume.

---
**Suivant :** `04_Mots_Cles_SEO.md` — non commercial, information juridique sobre.
