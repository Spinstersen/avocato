# 06 — Montage Holding Maroc : Cas Chiffré 1M Bénéfice (3 Scénarios)
...
*   Bénéfice avant impôt : 1 000 000 DH/an, stable sur 5 ans.
*   Gérant : résident fiscal Maroc (foyer + centre intérêts Casa).
*   Taux Maroc (CGI art.19, PLF à vérifier) : 15% ≤300k ; 20% 300k-1M ; 32% >1M.
*   UAE : corporate tax 9% au-delà de 375k AED ; substance = bureau + 2 salariés (~60-100k DH/an tout compris).

## Scénario A — SARL Casablanca seule
...
## Scénario B — Holding Dubai avec substance réelle
...
| **Total 5 ans** | | **souvent >500k vs ~925k net légal scénario A** |

## Le calcul que tout client doit voir (règle des 5 ans)
...
> « À votre niveau (1M), le montage Dubai vous coûte plus qu'il ne rapporte une fois la substance payée honnêtement. La version sans substance vous expose à ~300k de redressement. Mon conseil écrit : SARL optimisée aujourd'hui, revue de structure à 3M. »

---

## Note de méthode professionnelle

Information doctrinale — art.59 Loi 28-08, secret art.36, convention art.30. Chiffrage final par comptable agréé (liasse, retenues, régimes dividendes en vigueur). Références primaires : `sgg.gov.ma`, `tax.gov.ae`, `oc.gov.ma`, `oecd.org`. Chiffres vérifiés 21/08/2026 — re-vérifier PLF + FTA UAE à chaque diagnostic.
