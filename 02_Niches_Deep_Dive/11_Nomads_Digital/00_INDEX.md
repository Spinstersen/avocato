...
| 01 | `01_Persona_Lena_Nomad.md` | Qui |
| 02 | `02_Douleurs_Nomad_90j_vs_Carte.md` | 12 douleurs |
| 03 | `03_Carte_Sejour_1An_Procedure.md` | 30j préfecture |
| 04 | `04_SARL_Nomad_7_14j_Domiciliation.md` | Création 7-14j |
| 05 | `05_Compte_Bancaire_Nomad_Devise.md` | Devise résident 48h |
| 06 | `06_Fiscalite_Nomad_183j_Convention.md` | Résidence + conv. US art.27 |
| 07 | `07_Change_Nomad_Rapatriement_30j.md` | Rapatriement 30j |
| 08 | `08_Offre_Pack_Nomad_7500.md` | 5 packs FR+EN FR fait foi |
| 09 | `09_Canaux_NomadList_LinkedIn_Coliving.md` | Nomad List, colivings |
| 10 | `10_SEO_Nomad_Mots_Cles.md` | 20 long-tail nomad |
| 11 | `11_Cas_Pratiques_3_Nomads.md` | 3 cas chiffrés |
| 12 | `12_Fiches_Scripts_Nomad_FR_EN.md` | Scripts FR/EN |

## Matrice Touriste vs Carte

| Statut | Durée | Travail légal? | Résident 183j? | IS |
|---|---|---|---|---|
| Touriste 90j | 90j | Non (gris) | Non | 0 |
| Carte 1 an | 1 an | Oui si SARL/portage | Oui 210j | Mondial 15% |
