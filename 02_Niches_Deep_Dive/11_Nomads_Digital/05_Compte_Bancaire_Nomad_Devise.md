...
| Profil | Compte | Délai | Justif |
|---|---|---|---|
| Nomad 210j résident (Lena) | **Devise résident** (ou convertible) | 48h | Carte séjour 1 an + RC SARL + contrat US |
| Nomad 40j touriste (non-résident) | Convertible (si SARL) sinon perso | 48h | RC + passeport |

## Ouverture 48h (Attijari/CGP)

*   Carte séjour 1 an `03_Carte_Sejour_1An_Procedure.md` + RC SARL + CIN/passeport → 48h.

## Alimentation

*   Wise US 5k$ → devise résident 50k DH → justif 30j contrat+facture art.92 `09_Office.../07_Obligations...`.

## Erreur

*   Compte perso DH pour 5k$ → blocage J+30.
