...
```
CA >200k (service) ou >500k (commerce) 05_MRE_Foreign_Investors ?
...
**Pour MRE** : L'arbre évite l'erreur de choisir le statut avant la résidence — choisir SARL avant de savoir si l'on est résident 210j (IS mondial) ou non-résident 40j (IS source) inverse le conseil.
