...
## 3 cas chiffrés comparatifs — MRE investisseur

**Cas A — Karim MRE Paris, 40j/an Maroc, SARL Casa 100% export 500k DH CA, bénéfice 200k DH, pas de PE :**
Maroc : IS 15% = **30k DH**. France si création SASU même bénéfice : IS 25% au-delà 42,5k€ = **~45k DH** → **économie 15k DH** Maroc. Dividende 100k DH vers Paris : retenue **10% =10k** via 5000-F + devise MRE 72h vs **30k PFU** sans → **économie 20k**. Procédure : procuration apostillée (préfecture FR 15€ + Apostille Cour d'appel 14j) + statuts + RC 7-14j → SARL opérationnelle sans déplacement. Résidence : 40j <183j + foyer Paris = **non-résident** → IS source only, pas d'IR mondial MA §01.

**Cas B — Nadia MRE Bruxelles, 190j Maroc mais foyer Bruxelles, boutique e-commerce 800k DH CA Maroc :**
183j > seuil → **résidente fiscale Maroc malgré foyer BE** (CGI art.23 : 183j suffit, pas besoin foyer) → IS mondial 15% = **IS sur revenus BE non déclarés = redressement 30% pénalités**. TVA 20% due (client Maroc) = **160k DH** TVA collectée ; si elle facture client Paris → exon 0% art.92 possible uniquement si SWIFT 30j. Carte séjour 1 an obligatoire (210j >90j) **200 DH 30j** vs carte BE 2 ans 140€. **Leçon : compter cachets 365j glissants avant choix devise MRE vs convertible.**

**Cas C — Youssef MRE Madrid, SARL Casa + succursale Madrid avec salarié signataire 8 mois :**
PE caractérisé art.5/7 Conv. ES-MA 1985 → bénéfice rattaché ES **200k DH ×25% =50k IS ES** + IS Maroc sur reste 200k =30k → total **80k** vs **30k** sans PE (économie manquée **50k**). Dividende 80k ES → retenue **10% ES =8k** via formulaire ES 210 + crédit art.27 = 8k. Alternative sans PE (agent sans pouvoir de signer) → SARL Casa seule → total 30k + dividende 10% =38k → **économie 42k/an**. Banque : rapatriement 30j impossible si facturation ES (PE) → facturer depuis ES, pas export art.92.
...
*   §01 Résidence 183j → §09 SARL + §08 Carte : 40j = non-résident + pas de carte ; 210j = résident + carte 1 an 200 DH + IS mondial.
*   §02 PE 6m → §07 Convention art.7/27 : PE détermine où taxer → crédit art.27 réduit double imposition mais PE coûte 25% FR.
*   §03 Rapatriement 30j + §04 TVA art.92 + §12 Compte : export Paris → facture 0% + SWIFT 30j → convertible 48h ; client Maroc → TVA 20% → pas de rapatriement.
*   §10 Provision 50% + §11 DOC art.443 : convention apostillée + provision avant CRI — sinon impayé à distance + pas de preuve >10k.
*   §06 09-08 + §05 OMPIC : boutique MRE avec 09-08 registre 30j avant CMI, marque 35/9 1 200 DH/classe avant pub.

## Procédure crédit art.27 + 5000-F (détail MRE)
...
*   [ ] Résidence 183j/foyer comptée (365j glissants) + choix devise MRE vs convertible §01 §12
*   [ ] Test PE 3 questions (bureau >6m / salarié signataire FR/BE/ES) §02 — si OUI → filiale vs portage 8%
*   [ ] Apostille procuration 14j + statuts + provision 50% §10 avant dépôt CRI 7-14j §09
*   [ ] Attestation DGI 30j + 5000-F Bofip avant dividende → retenue 10% FR /15% BE §07
*   [ ] Facture art.144 + art.92 si export + SWIFT 30j → devise MRE 72h transférable §04 §03
*   [ ] Carte séjour 1 an 200 DH si >90j gérant + dotation 15k/100k IGOC §08 §03
*   [ ] Registre 09-08 30j + OMPIC 35/9 si boutique avant CMI §06 §05
