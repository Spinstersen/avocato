...
- **FR:** contrats, emails, LinkedIn (80%)
- **AR:** plaidoirie, client AR, Darija oral adouci
- **EN:** clients offshore, contrats FR/EN, Stripe docs

## Mapping vocab

| FR | EN | AR |
|---|---|---|
| Convention honoraires | Fee agreement | اتفاقية أتعاب |
| Provision | Retainer | تسبيق |
| Clause IP | IP assignment | بند الملكية الفكرية |

## Workflow

Rédiger FR → DeepL → relecture humain EN → valider AR si besoin 3e relecture.
