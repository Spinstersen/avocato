...
- Trop familier "Salut" → "Bonjour [Prénom]"
- Trop pompeux "Il convient de solliciter" → "Merci de m'envoyer"
- Trop vendeur "Offre limitée" → "2 options, vous choisissez"
- Trop technique "art 258 DOC al2" sans explication → "art 258 DOC (clause pénale = 10%)"
