# 06 — Outils LanguageTool + Antidote

## Stack

- **LanguageTool** (gratuit) → extension Chrome/Gmail/Notion, 0 faute avant envoi.
- **Antidote** (payant) → si volume >20 pages/sem.
- **DeepL** → FR↔EN, mieux que Google.
- **Whisper** → dictée voice note → correction.

## Workflow 2 min avant envoi

Écrire → LanguageTool corrige → lire à voix haute 30s → envoyer.

## KPI

Objectif 0 faute / 500 mots. Mesurer fautes/sem → streak.
