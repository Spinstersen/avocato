# 08 — Comparatif Styles Cabinets

| Style | Exemple | Perçu | Pour qui |
|---|---|---|---|
| Classique pompeux | "Nous avons l'honneur" | distant | grand cab Casa |
| Sobre clair (recommandé) | "À noter: 3 risques" | pro + humain | solo tech-savvy |
| Familier startup | "Hey!" | non pro | à éviter |

Avocat solo différencié → sobre clair.
