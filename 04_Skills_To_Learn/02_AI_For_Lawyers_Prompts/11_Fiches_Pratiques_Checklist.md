...
- [ ] Anonymisé (Ctrl+F 0 hit nom/montant/ville)
- [ ] Prompt avec rôle + contraintes + garde-fou
- [ ] Opt-out entraînement activé
- [ ] Temps relecture 15 min bloqué calendrier

## 5 prompts bonus

P11 Audit 09-08, P12 Générer FAQ, P13 Traduire clause EN→FR sobre, P14 Générer plan article SEO, P15 Résumer réunion 30 min en 5 bullets.

## Erreurs top 5

1. Publier brut → sanction
2. Soumettre dossier identifié → secret
3. Citer arrêt sans vérifier → hallucination
4. Pas de registre CNDP → sanction
5. Croire IA = avocat → responsabilité
