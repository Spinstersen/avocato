...
- **Art 36 Secret:** soumettre dossier identifié à OpenAI = violation. Anonymiser ou local.
- **Art 59 Responsabilité:** l'avocat signe = responsable. "C'est l'IA" n'est pas défense disciplinaire.
- **Publicité mensongère:** publier arrêt halluciné = faute (voir `01_Strategy/01_Rules/08_Sanctions`).

## Protocole validation 4 yeux

1. IA draft → 2. Toi relecture fond (vérifier 2 sources primaires) → 3. LanguageTool FR → 4. Publier.

## Checklist avant publication IA

- [ ] Anonymisé?
- [ ] 2 sources vérifiées (sgg.gov.ma, cndp.ma, jep.ma)?
- [ ] 0 promesse résultat?
- [ ] Ton sobre (0 superlatif "meilleur")?
- [ ] Signature sobre?

## Cas disciplinaire (FR)

Avocat US 2023 sanctionné pour mémoire citant arrêts ChatGPT inventés. Transposable Maroc.
