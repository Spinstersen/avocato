...
- **Taux hallucination:** sur 10 prompts avec réf loi, combien inventent art? Cible <10% après garde-fou "n'invente pas".
- **Temps gagné:** draft IA 10 min vs rédaction 45 min = 35 min gagnées, mais relecture 15 min → net 20 min.
- **Qualité:** score relecture (fautes/10, réf fausses). Objectif <1 faute/500 mots.

## Dashboard mensuel

| Mois | Prompts | Hallucinations | Temps net gagné | Posts publiés |
|---|---|---|---|---|
| M1 | 20 | 4 (20%) | 6h | 4 |
| M2 (avec garde-fou) | 25 | 2 (8%) | 8h | 6 |

## Amélioration

Ajouter systématiquement "Cite source sgg.gov.ma ou dis je ne sais pas" → hallucination -50%.
