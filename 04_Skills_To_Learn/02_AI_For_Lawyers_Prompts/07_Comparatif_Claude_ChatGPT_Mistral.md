...
|---|---|---|---|---|
| FR juridique | 9/10 | 8/10 | 9/10 (FR natif) | 7/10 |
| Hallucination | 15% | 20% | 18% | 25% |
| Hébergement | US | US | UE (Paris) | Local (ton PC) |
| CNDP | Moyen | Moyen | Bon (UE) | Excellent (0 transfert) |
| Prix | $20 | $20 | $15 | Gratuit |
| Contexte | 200k | 128k | 32k | 8k |

## Quand utiliser quoi

- **Claude** — posts, reformulation FR (meilleur FR)
- **ChatGPT** — brainstorm, carrousel, veille
- **Mistral** — si barreau strict UE + FR natif
- **Local** — dossier sensible anonymisation douteuse

## Stack recommandé

Claude Pro ($20) + Mistral gratuit en backup + Ollama local pour secret absolu.
