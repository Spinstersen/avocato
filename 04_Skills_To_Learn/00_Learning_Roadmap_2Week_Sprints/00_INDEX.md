...
## TL;DR exécutif
- **1 compétence / 2 semaines = 1 livrable vendable.** Pas de théorie sans production.
- **30 min/jour après Deep Work**, pas avant. Sinon procrastination garantie.
...
| Comportement | Risque | Verdict |
|---|:---:|---|
| Lire 5 livres en parallèle | Burnout + 0 rétention | ❌ |
| 1 sprint / 2 semaines + livrable | Compounding | ✅ |
| Apprendre avant de vendre le pack | Procrastination déguisée | ❌ |
| Just-in-time (apprendre quand besoin client) | Cash rapide | ✅ |
| Vidéo 3h sans notes | Divertissement | ❌ |

## Liens vault
- Préalable: `01_Strategy/05_ADHD_Operating_System_Overview/03_Regles_Fondamentales.md`
- Stack: `01_Legal_Tech_Stack/` — outils à apprendre
- Sharpness: `07_Sharp_Legal_Mind/` — routine hebdo
- Livres: `08_Livres_Cours_Recommandes/` — quoi lire
