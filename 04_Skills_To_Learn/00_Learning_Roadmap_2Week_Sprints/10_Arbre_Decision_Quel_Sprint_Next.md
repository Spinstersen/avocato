# 10 — Arbre de Décision : Quel Sprint Faire Ensuite ?

```
START: As-tu vendu 3 packs freelance ce mois ?
 ├─ NON → Sprint 8 Vente SPIN (cash NOW) → S2 Loom/Calendly
 └─ OUI → As-tu Brand Kit Canva ?
       ├─ NON → Sprint 3 Canva
       └─ OUI → As-tu 1 article SEO indexé ?
             ├─ NON → Sprint 5 SEO
             └─ OUI → As-tu 5 prompts IA validés ?
                   ├─ NON → Sprint 7 IA
                   └─ OUI → Sprint 11 Issue-Spotting
```

## Matrice Impact/Effort

| Sprint | Impact CA 30j | Effort 10j | Priorité |
|---|---|---|---|
| Vente SPIN | 10/10 | 6/10 | P0 |
| Loom/Calendly | 9/10 | 3/10 | P0 |
| Canva | 7/10 | 4/10 | P1 |
| SEO | 6/10 (LT) | 7/10 | P1 |
| IA | 6/10 | 4/10 | P1 |
| Français | 5/10 | 5/10 | P2 |

## Checklist avant de choisir

- [ ] Ai-je un client qui attend ce livrable cette semaine? → Fais ce sprint
- [ ] Mon énergie est basse? → Sprint plaisir (Canva/IA) pas SEO
- [ ] J'ai 2h dispo samedi? → Batch contenu, pas nouveau sprint
