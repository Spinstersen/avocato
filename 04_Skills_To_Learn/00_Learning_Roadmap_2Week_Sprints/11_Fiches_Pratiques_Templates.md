...
```
Sprint [ ] — [Compétence] — Dates: __/__
J1 [ ] J2 [ ] J3 [ ] J4 [ ] J5 [ ] J6 [ ] J7 [ ] J8 [ ] J9 [ ] J10 [ ]
Récompense J10: ________________  Streak: __
```

## Template Sprint Notion (markdown à coller)

Voir `03_Systeme_Suivi_Notion_Learning.md`

## Template Veille 5 min (quotidien)

- Source: [Médias24/LeBrief/cndp.ma]
- 1 fait: "..."
- 1 phrase client: "Ça veut dire que si tu ... tu risques X DH"
- Idée content: [post/carrousel]

## Template Auto-évaluation fin sprint

- Qu'ai-je appris (3 bullets)?
- Qu'ai-je produit (lien)?
- Qu'est-ce qui m'a bloqué?
- Prochain sprint pertinent? Oui/Non → lequel?
