# 03 — Vente Négociation (6 livres)

SPIN, Challenger, Cialdini, Getting to Yes, Never Split, Mom Test.
Méthode: résumé YouTube 15m → 3 takeaways → 1 script diag.
Ex: Cialdini réciprocité → donner note avant vente.
