# 09 — Comparatif Résumés vs Livres

Résumé 30m = 80% valeur si appliqué. Livre 20h = 100% mais risque non lu.
Règle: résumé d'abord, livre entier seulement si 2 missions facturées sur sujet.
