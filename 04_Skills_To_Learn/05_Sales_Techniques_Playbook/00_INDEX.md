...
SPIN, Challenger, BATNA, anchoring, objection-handling, closing. Tous les outils pour transformer un diagnostic en mission signée, sans pression.
...
Connaître sa meilleure alternative avant de négocier.
- BATNA avocat : refuser la mission si prix trop bas.
- BATNA prospect : aller voir un confrère.
- Si BATNA avocat > offre prospect, refuser.

### 4. Anchoring

Présenter l'option la plus chère en premier.

### 5. SPIN + Challenger combo

Diagnostic SPIN + proposition Challenger.

## Les 10 objections fréquentes

1. « C'est trop cher. » → Reformuler en valeur perçue (5 livrables pour 2 900 DH = 580 DH/livrable).
2. « L'avocat d'en face va gérer. » → Spécialisation et gain de temps.
3. « Je vais attendre. » → Coût du problème si non résolu.
...
- Présenter 2 options (Essentielle vs Étendue).
- Demander la préférence, pas l'engagement.
- Envoyer la convention par Yousign sous 24h.
