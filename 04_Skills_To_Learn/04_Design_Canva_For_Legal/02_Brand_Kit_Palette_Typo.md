...
- Navy #0F2A44 (titres, header) — autorité
- Beige #F5F1E8 (fond) — chaleur
- Teal #1FA89E (accent, CTA sobre) — tech
- Gris clair #E5E5E5 (séparateur)
- Gris foncé #333333 (texte)

## Typo

- Titres: Inter Bold / General Sans Medium
- Corps: Inter Regular 11pt
- Arabe: IBM Plex Sans Arabic
- Code: JetBrains Mono (si clause)

## Logo

Wordmark texte seul "CABINET [NOM]" Navy, pas d'icône balance. Favicon N lettre Navy.

## Setup Canva Brand Kit

Brand → Brand Kit → ajouter palette + fonts + logo PNG transparent + photos sobres (Unsplash triées).
