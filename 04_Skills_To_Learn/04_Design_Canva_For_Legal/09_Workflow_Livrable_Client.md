...
1. BRIEF (Notion)          → 2. GABARIT (Canva T1-T4)   → 3. CONTRÔLE (fichier 10)
   ...
   périmètre, livrables        NEVER from scratch            + relecture LanguageTool
                                                                      ↓
5. SIGNATURE & ARCHIVE  ← 4. LIVRAISON (Drive + Loom) ←   export PDF impression
...
4. **Livraison** — Drive (`Clients/[Réf]/Livrables/`) + email sobre (objet : « Vos livrables — [Réf] ») + Loom 3-5 min qui explique COMMENT lire le document (une page par minute ; c'est le livrable qui fait la différence perçue, pas l'effet).
...
> J+18 : livraison par Drive + Loom 5 min « comment lire vos statuts et quoi faire à la banque ».
...
3. **Livrer sans Loom** : le document sans explication se surinterprète ; 3 minutes de voix évitent 30 minutes de questions (et installent l'autorité pédagogique).
