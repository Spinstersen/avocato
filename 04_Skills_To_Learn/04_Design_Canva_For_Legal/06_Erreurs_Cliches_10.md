...
2. 5 couleurs → 2+1
3. Times New Roman → Inter
4. Logo pixelisé → PNG 2000px
5. Mur texte → listes + tableaux
6. Stock Canva vu 1000× → Unsplash trié
7. Flèche rouge miniature → sobre
8. CTA "Achetez" → "En savoir plus"
9. Footer vide → mentions barreau
10. Pas de marge → 20mm blanc
