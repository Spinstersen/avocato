...
P1 Cover Navy titre + wordmark, P2 Cabinet 3 piliers, P3-4 Missions 3 packs avec prix HT, P5 Process 4 étapes, P6 Contact sobre.

## Contrat design

- Header Navy + titre "Contrat de Prestation"
- 2 colonnes FR/EN si besoin, numérotation art 1-12
- Cases à cocher pour options
- Footer: "Paraphez chaque page, signez dernière"

## Livraison

PDF + Loom 5 min walkthrough. Client signe Yousign.
