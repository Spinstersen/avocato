...
Client paie 2900 DH pour fichier qui ressemble à 2900 DH. Word Times + logo pixelisé = perçu 500 DH. Canva sobre = perçu premium.

## 3 principes

1. **Sobriété:** moins = plus. 2 couleurs + 1 typo + beaucoup de blanc.
2. **Hiérarchie:** H1 32pt Bold, H2 18pt Medium, corps 11pt, interligne 1.5.
3. **Cohérence:** même palette/header/footer sur TOUS livrables.

## Inspiration

Stripe docs, Notion, Linear — pas Barreau site 2010.
