...
|---|---|---|---|---|---|
| Hard sell | 10% | 90% | 20% (remords) | ❌ | À éviter |
| SPIN | 70% | 10% | 45% | ✅ | Cœur |
| Challenger | 50% | 30% | 40% | ✅ | Complément |
| Consultative | 60% | 20% | 35% | ✅ | OK |

## Verdict

SPIN 70% + Challenger 30% = meilleur. Hard sell = sanction + mauvais bouche-à-oreille.
