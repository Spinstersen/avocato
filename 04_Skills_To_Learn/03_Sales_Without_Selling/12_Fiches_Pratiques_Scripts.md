# 12 — Fiches Pratiques Scripts DM/Email/WhatsApp

## Script DM entrant (sobre, déonto OK)

"Bonjour [Prénom], merci pour votre message. Pour vous proposer mission adaptée, je propose diagnostic 45 min 600 DH HT (art30) avec note risques + devis. Lien Calendly: [sobre]. Bien à vous — [Nom], barreau [Ville]"

## Script post-diagnostic email

Objet: Votre note de risques + 2 options
Corps: 3 risques H/M/B + tableau 2 options + lien Yousign + Loom 3 min. Pas de "Achetez maintenant".

## Script refus paiement noir

Voir `04_Objections` #7.

## Checklist avant envoi

- [ ] Sobre (0 superlatif, 0 promo)
- [ ] Art30 mentionné
- [ ] 2 options pas 1
- [ ] Lien sobre, pas de pop-up
