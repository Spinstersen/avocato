...
| J | Canal | Message |
|---|---|---|
| J+1 | Email | Note + conventions (sobre) |
| J+3 | Email | "Avez-vous pu lire? Question?" |
| J+7 | WhatsApp/Email | Partage article utile (pas relance) |
| J+14 | Email | Témoignage anonymisé "client similaire a choisi X" |
| J+21 | Email | "Je classe sans réponse sauf si vous me dites" |
| J+30 | LinkedIn | Interaction post prospect (pas DM) |
| J+60 | Newsletter | Reste dans boucle contenu |

## Règle

Jamais 2 relances sans valeur. Toujours apporter (article, checklist). Stop à J21 si silence.

## Si oui

→ Yousign → provision → Notion Mission → Loom intro.

## Si non

→ Noter raison Notion (prix/timing/concurrence) → nourrir FAQ.
