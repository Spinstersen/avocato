...
S: "600k DH AE, clients US, Payoneer" → P: "Pas contrat" → I: "IP code = qui possède?" → N: "Contrat FR/EN 7j = dormir tranquille" → Offre 2900/5900.

## Niche 2 Ecom YouCan (Fatima)

"30k/mois, pas CGV, CMI bloque" → I: "Amende CNDP 300k, litige client" → Offre CGV 4900.

## Niche 3 09-08 PME

"Collecte emails 5k" → I: "Sanction 300k + perte client UE GDPR" → Offre 12k.

## Niche 4 Creator

"Contrats influenceur bouche" → I: "Non-paiement marque" → Offre 2500.

## Niche 5 MRE

"Veut SARL distance" → I: "Blocage CRI si pas présent" → Offre 6900.

## Niche 6 AE→SARL

"Plafond dépassé" → I: "Redressement 3 ans" → Offre 4900.

Chaque cas: 3 questions S, 1 Teach, 2 options.
