...
3. **Autorité:** citer art DOC exact + CNDP → crédibilité.
4. **Rareté douce:** "2 diagnostics/sem max" (vrai, timebox) → pas de fausse rareté.
5. **Engagement:** petit oui (diagnostic 600) → grand oui (pack 2900).
6. **Sympathie:** ton humain, Loom face cam → connexion.

## Éthique

Jamais manipuler (fausse rareté, pression). Utiliser pour clarifier valeur, pas tordre.
