# 10 — Public Speaking & Ateliers : Nouveau Skill Bonus

> Skills n°10 — 11 fichiers. Atelier 60 min gratuit en coworking = #1 conversion (40% diag). Sobre, pédagogique, 0 pitch.

## Structure atelier 60 min

0-10 accueil, 10-40 3 risques + 2 cas, 40-50 checklist, 50-60 fiche contact + QA. Pas de pitch 4900 DH pendant atelier (voir `01_Strategy/01_Rules/07_Zones_Grises`).

## Map

01 Anatomie atelier, 02 Storytelling SCQA, 03 Slides 10, 04 Animation, 05 Gestion QA, 06 Suivi post-atelier, 07 Métriques NPS, 08 Erreurs, 09 Arbre choix sujet, 10 Checklist orga 15j.
