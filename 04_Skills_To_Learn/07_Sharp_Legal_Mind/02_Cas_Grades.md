# 02 — 10 Cas Gradés Corrigés

## Cas 1 Freelance dev (voir 01_Issue_Spotting.md:60) — corrigé détaillé

Risques H: plafond AE 600k>400k → redressement 3 ans + 30% majoration = 180k DH
Action: SARL 4900 + contrat 2900 + régul TVA.

## Cas 2-10 (résumés)

Cas2 Ecom 30k/mois sans CGV → CGV 4900
Cas3 PME 5k emails sans registre → 12k 09-08
Cas4 Creator sans contrat marque → 2500
Cas5 MRE SARL distance → 6900
Cas6 AE→SARL urgence → 4900
Cas7 SaaS collecte données US → GDPR 15k
Cas8 Agence 3 freelances sans contrat → 5900
Cas9 Dropshipper litige COD → 4900
Cas10 Startup levée 5M → pacte associés 12k

Chaque cas: faits 5 lignes → 7 cat checklist → 3 risques chiffrés → 2 options prix.
