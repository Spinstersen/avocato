# 07 — Comparatif Méthodes Raisonnement

| Méthode | Quand | Exemple |
|---|---|---|
| Issue-spotting | diagnostic | 7 catégories |
| SCQA | note/post | S-C-Q-A 4 blocs |
| IRAC | mémoire | Issue-Rule-Application-Conclusion |
| Deal reasoning | pricing | structure/risque/prix |

SCQA > IRAC pour client (plus narratif).
