...
Stripe changelog, Shopify, YouCan, OMPIC. Noter 1 feature → "Que change pour client?"

## Mercredi IA 20 min

Tester 1 outil (Perplexity, Mistral) → note 2 lignes.

## Vendredi Founder

1 interview/podcast → vocabulaire client ("MRR, churn, MVP").

## Daily 10 min FB groups

Groupes niche → questions réelles → or pour content.
