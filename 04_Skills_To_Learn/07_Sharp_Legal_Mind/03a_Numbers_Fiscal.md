# 03a — Numbers Fiscal & Juridique (Split 2.0)

> Split 2.0 du master `03_Numbers_Sheet.md` — source vérité inchangée. Ne dupliquez pas ailleurs.

Déclinaison fiscal/juridique du Numbers Sheet : chaque chiffre porte sa valeur, sa base légale, sa source datée et **sa procédure de mise à jour avec échéance nominale**. Un chiffre sans millésime ni base légale = hallucination, jamais cité en diagnostic.

## Tableau fiscal & juridique
...
| Délais délib. CNDP 40-22 | **Déclaration 30j / mise en demeure 45j** | Délib. 40-22 art.12/14 | cndp.ma, 15/02/2025 | Veille CNDP **trimestrielle** |
| Capital SARL minimum | **10 000 DH** | Loi 5-96 art.6 | sgg.gov.ma, Loi 5-96, 20/08/2026 | Surveiller la réforme Loi 5-96 au BO — rythme semestriel |
...
- [ ] **15/07** — oc.gov.ma : condition de rapatriement 30j intégrée à l'exonération TVA export
...
**Sources primaires seules :** `sgg.gov.ma` (Lois 114-13 / 5-96 / 09-08, CGI), `cndp.ma` (art.52, délib. 40-22), `oc.gov.ma` (IGOC), `ompic.ma` / `directompic.ma` (tarifs, délais), Bofip (conventions France uniquement). Aucune source secondaire.

**Renvoi master :** tout usage en diagnostic suit la formule SPIN-I du master (`chiffre + base légale + risque chiffré + ROI mission`) ; glossaire `00_START_HERE/03_Glossaire_12_Concepts_Cles.md` §01, §04, §06, §09. Splits frères : `03b_Numbers_Social.md`, `03c_Numbers_Change.md`.
...
Vérifié le 23/08/2026 — prochaine revue programmée : PLF du 01/10.
