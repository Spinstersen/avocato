# Template: Mission Conformité e-commerce — CGV + Mentions Légales (Loi 31-08 + 09-08)

```
PAGE GARDE : CGV — [Nom Boutique] — Conformes Loi 31-08

ARTICLE 1: Identité du vendeur (ICE, IF, RC, adresse, WhatsApp, email obligatoire)
ARTICLE 2: Produits & Prix (DH TTC, frais livraison)
...
ARTICLE 10: Propriété intellectuelle site

MENTIONS LÉGALES (page séparée):
- Éditeur: [SARL/AE Nom, ICE, adresse]
- Hébergeur: [YouCan/Shopify + adresse]
- Contact: [email, WhatsApp]
- CNDP autorisation N° [si applicable]

POLITIQUE DE CONFIDENTIALITÉ 09-08 (1 page):
- Données collectées: nom, tel, adresse (pour livraison)
- Finalité: traitement commande + SAV
- Base légale: consentement + exécution contrat
- Durée: 3 ans
- Droits: accès, rectif, opposition via [email]
- Cookies: [si Shopify]

POLITIQUE LIVRAISON & RETOUR (version courte pour page checkout):
- Livraison 24-72h via [transporteur], frais [X] DH, offerts dès [Y] DH
- Retour sous 7 jours, produit non utilisé, formulaire WhatsApp [num]

CONTRAT FOURNISSEUR (annexe):
- Clause qualité, délais, litige, remboursement stock défectueux
