# Modèle : Procès-verbal de remise & Clôture de mission

```
PROCÈS-VERBAL DE REMISE — Mission CH-2025-[015]

Le [Date], Me [Nom] a remis à [Client] :
...
Solde réglé : [Oui — Facture FH-012 / Non — échéance JJ/MM]

Signatures :
Me [Nom] ________________      Client ________________

Suite : [ ] Mission clôturée  [ ] Abonnement mensuel proposé
Prochaine échéance (si abonnement/AG) : [Date]
```

**À archiver** dans le dossier. Preuve de remise, utile en cas de litige d'honoraires.
