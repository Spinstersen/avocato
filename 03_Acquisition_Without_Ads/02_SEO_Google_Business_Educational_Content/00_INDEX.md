# 02 — SEO et Google Business : playbook complet

> **Dossier maître — Canal d'acquisition n°2.** Comment être trouvé sur Google quand un prospect cherche à résoudre un problème juridique précis.

## TL;DR

Le SEO est l'antidote naturel à la publicité. Cibler le long-tail, produire 12 articles/12 semaines, Google Business Profile complète, 90-180 jours pour les premiers résultats.

## Fichiers

- `00_INDEX.md`
- `01_Strategie_SEO_Long_Tail.md`
- `02_Google_Business_Profile.md`
- `03_Calendrier_Editorial_12_Semaines.md`
- `04_Mesure_KPI_SEO.md`

## Principes

- **Long-tail** : requêtes précises, faible concurrence.
- **Contenu de fond** : 1 500-3 000 mots, structuré.
- **Maillage interne** entre articles.
- **Mises à jour** régulières.
- **Local SEO** via Google Business Profile.

## Requêtes cibles par niche

Voir les fichiers `02_Niches_Deep_Dive/[niche]/04_Mots_Cles_SEO.md`.
